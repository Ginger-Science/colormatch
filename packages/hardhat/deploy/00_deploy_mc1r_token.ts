 ...
 */
const deployMc1rToken: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
...
export default deployMc1rToken;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags YourToken
deployMc1rToken.tags = ["Mc1rToken"];